...
void MainTests::testSavingSessions()
{
    try
    {
        ...
        std::shared_ptr<Client> c1(new Client(0, t, nullptr, ConnectionProtocol::Mqtt, false, nullptr, settings, false));
        ...
        std::shared_ptr<Client> c2(new Client(0, t, nullptr, ConnectionProtocol::Mqtt, false, nullptr, settings, false));
...
void MainTests::testParsePacketHelper(const std::string &topic, uint8_t from_qos, bool retain)
{
    ...
    std::shared_ptr<Client> dummyClient(new Client(0, t, nullptr, ConnectionProtocol::Mqtt, false, nullptr, settings, false));
...
void MainTests::testTopicMatchingInSubscriptionTreeHelper(const std::string &subscribe_topic, const std::string &publish_topic, int match_count)
{
    ...
    std::shared_ptr<Client> client = std::make_shared<Client>(0, td, nullptr, ConnectionProtocol::Mqtt, false, nullptr, *settings, false);
